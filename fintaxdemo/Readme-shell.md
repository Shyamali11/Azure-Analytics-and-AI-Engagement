...
24. **Click** on ‘CEO Dashboard - May’ Report.
...
46. Similarly pin left image tiles from ‘page 1’ of chicklets report to the CEO Dashboard - May.
...
55. **CDP Vision Report** should look like this. Following are the details of tiles for the same.
...
57. **CDP Vision Report** should look like this. Following are the details of tiles for the same.
...
59. **CDP Vision Report** should look like this. Following are the details of tiles for the same.
